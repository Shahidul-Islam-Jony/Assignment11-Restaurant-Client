...
const LocationAndContact = () => {
    return (
        <div className="flex my-28">
            <div className="w-1/2 border-r-4 border-r-green-500">
                <div className="px-10">
            ...
            <div className="w-1/2">
                <div className="px-10">
                    <div className="mb-10">
                        ...
                        <p className="text-4xl indent-16 text-green-700 mb-2">Thu - Friday</p>
                        <p className="text-3xl indent-16 text-green-700 mb-8">10 am - 11 pm</p>
                        <p className="text-4xl indent-16 text-green-700 mb-2">Sunday - Monday</p>
                        <p className="text-3xl indent-16 text-green-700 mb-5">9 am - 10 pm</p>
                    </div>
                    <div className="mb-10">
                        <li className="text-3xl text-pink-600 font-medium font-serif">Location</li>
                        <p className="text-4xl indent-16 text-green-700 mb-2">BD. Rajshahi,</p>
                        <p className="text-3xl indent-16 text-green-700 mb-5">Natore</p>
                    </div>
                    <div>
                        <li className="text-3xl text-pink-600 font-medium font-serif">Contact Us</li>
                        <p className="text-4xl indent-16 text-green-700 mb-2">Phn: +880179494...</p>
                        <p className="text-3xl indent-16 text-green-700 mb-2">Tel: +9127.....</p>
                        <p className="text-3xl indent-16 text-green-700 mb-2">Email: user@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
